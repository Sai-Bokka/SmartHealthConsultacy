...
{
    return(
   <div className="container mrg" style={{marginTop: "150px"}}>
 ...
 <Fade  top>
  ...
  <Fade  top>
  <Card>
    <Accordion.Toggle as={Button} eventKey="18">
  ...
  <Fade  top>
  <Card>
    <Accordion.Toggle as={Button} eventKey="19">
  ...
  <Fade  top>
  <Card>
    <Accordion.Toggle as={Button} eventKey="20">
...
It may be possible that people can get COVID-19 by touching a surface or object, such as a food package or dining ware that has the virus on it and then touching their own mouth, nose, or possibly their eyes.</Card.Body>
  ...
  <Fade  top>
  <Card>
    <Accordion.Toggle as={Button} eventKey="21">
  ...
  <Fade  top>
  <Card>
    <Accordion.Toggle as={Button} eventKey="22">
  ...
  <Fade  top>
  <Card>
    <Accordion.Toggle as={Button} eventKey="23">
